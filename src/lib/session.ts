...
// user from a signed session cookie, falling back to the account owner
// (bootstrapping one on first request if none exists yet) so the rest of
// the app has someone to attribute actions to without a login step.
